...
Ticket todos/auth-providers/03: the ExternalIdentity branch of finish_login,
the identities table, per-provider signups modes, shared abuse caps, and the
delete/reject/disable identity-cascade rules.

Kept in its own file so tests/test_providers.py (ticket 01/02) stays untouched.
A test provider builds an ExternalIdentity from query args and calls
...
# ==========================================================================
# Unlinked identity → signups policy
# ==========================================================================
