...
# discovered via its entry point) so the login page shows a "Continue with
# Demo PIN" button, the Configuration page shows an enabled external-provider
...
# live registry → "Demo PIN") alongside the password method.
